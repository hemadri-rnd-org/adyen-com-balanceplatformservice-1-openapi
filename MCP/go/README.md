# Configuration API MCP Server

This MCP (Model Content Protocol) server provides access to Configuration API API functionality through HTTP, HTTPS, and STDIO transport modes.
