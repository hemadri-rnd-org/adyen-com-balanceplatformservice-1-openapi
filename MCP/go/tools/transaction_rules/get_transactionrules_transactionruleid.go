...
func Get_transactionrules_transactionruleidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.TransactionRuleResponse
...
func CreateGet_transactionrules_transactionruleidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_transactionRules_transactionRuleId",
		mcp.WithDescription("Get a transaction rule"),
		mcp.WithString("transactionRuleId", mcp.Required(), mcp.Description("The unique identifier of the transaction rule.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Get_transactionrules_transactionruleidHandler(cfg),
	}
}
