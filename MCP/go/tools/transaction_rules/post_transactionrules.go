...
func Post_transactionrulesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/transactionRules", cfg.BaseURL)
...
func CreatePost_transactionrulesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_transactionRules",
		mcp.WithDescription("Create a transaction rule"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_transactionrulesHandler(cfg),
	}
}
