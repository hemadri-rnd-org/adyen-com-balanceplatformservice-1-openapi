...
func Post_documentsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/documents", cfg.BaseURL)
...
func CreatePost_documentsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_documents",
		mcp.WithDescription("Upload a document for verification checks"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_documentsHandler(cfg),
	}
}
